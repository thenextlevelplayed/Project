                            ...
                            <div class="container p-5">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <img src="\assets\img\default-image.jpg" alt="" id="showImg"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <div class="col-md-12 mb-3">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="1" name="title"></textarea><br>
                                            </div>

                                            <div class="col-md-12 mb-3">
                                                <label for="exampleFormControlTextarea2">消息內容</label>
                                                <textarea class="form-control" id="exampleFormControlTextarea2" rows="11" name="content"></textarea>
                                            </div>
                                        </div>
                                    </div>
