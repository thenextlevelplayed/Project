                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                {{-- {{$d->Oid}} --}}
                                                <td><a href="/main/order/1" class="link" style="background:0 ; color:#000000">KMO20220623001</td>
                                                {{-- {{$d->firstName}} --}}
                                                <td>
                                                    華碩
                                                </td>
                                                ...
                                                <td >
                                                    <div class="btn-group">
                                                        {{-- {{ url('/home') }} --}}
                                                        <a href="/main/order/edit/1" class="btn" style="background: 0 ; color:rgb(122, 122, 122)">
