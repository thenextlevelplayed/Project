        ...
        <table class="table" style="">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="btn btn-warning">未出貨</td>
                </tr>
                <tr>
                    <th scope="row">2</th>
                    <td>KMD20220623001</td>
                    <td>華碩</td>
                    <td ><svg class="btn" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></td>
                    <td class="btn btn-warning">未出貨</td>
                </tr>
                <tr>
                    <th scope="row">3</th>
                    ...
                    <td>華碩</td>
                    <td><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg></td>
                    <td class="btn btn-success">已出貨</td>
                </tr>
                <tr>
                    <th scope="row">4</th>
                    <td>KMD20220623001</td>
