...
(3,'思科打造Cisco Security Cloud開放的安全雲端平台，整合體驗更安心！','思科公布將建立一個全球雲端交付綜合平台，以確保所有大小、規模的企業安全和連接。思科正打造思科安全雲端（Cisco SecurityCloud），使其成為開放的平台，保護整個IT生態圈的完整性，避免公有雲的框限。思科安全雲端將提供整合體驗，使各地的用戶及設備能安全地連接到任何地方的應用程式和資料。透過統一管理，開放平台將提供大規模的威脅預防、檢測、響應和修復能力。思科也將持續致力實現安全雲端，分享其安全產品組合的創新進展。','',NULL),
(4,'大規模物聯網跨界應用 優納比助企業數位轉型','物聯網發展至今，已經漸漸進入到各個產業，對台灣來說，幫助許多傳統產業數位轉型，像是物流業、或是傳統的水電瓦斯業，都已經逐步接受物聯網的應用，節省支出成本，並獲取更多的利益。優納比在台灣，協助傳統產業提升了營運效率，靠的就是物聯網的技術，優納比在台灣不斷擴大，公司風氣也講究團隊合作分工，開放的工作環境，並且法國的自由管理模式，優納比現在正廣開電子工程師、系統工程師等相關職缺，等著你來加入！','',NULL),
